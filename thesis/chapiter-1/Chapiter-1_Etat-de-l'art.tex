...
\begin{titlepage}
	\begin{sffamily}
		...
		\end{figure}
		 ...
		 \HRule \\[0.4cm]
    { \huge \bfseries Détection de la température on se basant sur le teint de la peau chez les enfants cancéreux\\[0.4cm] }
    \HRule \\[2cm]
...
\addcontentsline{toc}{section}{Chapiter 1 : \' Etat de l'art}
\section*{\Huge{Chapiter 1}}
\subsection*{\huge{\' Etat de l'art}}
\newpage
\rhead{\textsc{Chapite 1 : \' Etat de l'art}}
...
\begin{figure}[h]
\centering
\includegraphics[ height=10cm, width=13cm]{img-Chapiter-1/shemadenourone.png}
...
Comme la détection des contours (comme dans la figure \ref{fig:détection}), la netteté, le lissage / flou (comme dans la figure \ref{fig:filter}) et l’appariement de motifs. ANN peut être utilisé pour apprendre les valeurs dans de nombreuses matrices de convolution, ce qui permet d'obtenir des filtres d'image qui s'activent lorsqu'ils sont exposés sur des caractéristiques ou des structures visuelles spécifiques.
\newpage
\begin{figure}[h]
	\centering
	\includegraphics[height=7cm,width=15cm]{img-Chapiter-1/CNN.png}
	\caption{détection de bord écrit en matrice de convolution 3×3}
	\label{fig:détection}
	\bigbreak
	\centering
	\includegraphics[height=7cm,width=15cm]{img-Chapiter-1/CNN2.png}
...
\newpage
\rhead{}
\addcontentsline{toc}{section}{Chapiter 2 : Context et problématique du projet}  
\section*{\Huge{Chapiter 2}}
\subsection*{\huge{Context et problématique du projet}}
\newpage
\rhead{\textsc{Chapite 2 : Context et problématique du projet}}
...
\subsubsection{Importance de la e-santé}
\begin{enumerate}
...
\subsubsection{Focus sur le Cancer}
...
\subsection{Santé connectée}
\subsubsection{Santé connectée implique} 
...
\subsubsection{Approche de la santé connectée offre trois niveaux de création de valeur}
\begin{itemize}
...
\end{itemize}
\newpage
\subsubsection{Principales fonctions de la santé connectée}
...
\subsubsection{Différents champs d’application de la santé connectée}
...
\subsubsection{Définition}
La température corporelle est définie comme la température moyenne du corps humain. La température moyenne est estimée à environ 37 C\textdegree{}, bien que cela puisse varier en fonction du moment de la journée, généralement de 0,5 C\textdegree{} le soir par rapport au matin. Le centre qui régule la température corporelle est situé dans une glande, l'hypophyse, et le point exact de régulation peut être modifié en cas de dommage ou de maladie, d'où l'apparition de fièvre lorsque le corps est infecté. 
...
\subsubsection{Cancer de l’enfant}
...
\subsubsection{Cancers les plus fréquents chez l’enfant}
...
\newpage
\subsection{Description du problème posé}
Le secteur de la santé en Algérie se caractérise par un manque de matériels de santé, le personnel n'est pas bien formé, l'indifférence chez quelques responsables en conséquent les malades souffrent et ils n'ont pas soigné comme il faut dans des cas on a des résultats catastrophiques, suite à des fautes médicaux et le manque des médecins compétent.\\
Aussi les hôpitaux ne sont pas propres, ils manquent de l'hygiène.
\newpage
...
\section{Conclusion}
La e-santé et les objets connectés qui en sous-tendent l'usage ne vont pas impacter  la médecine, mais bien le parcours de soin dans sa globalité.

La e-santé et les objets connectés  provoquent une grande révolution, Ils génèrent pour l’individu et la collectivité une masse de données inédite, qui crée de nouveaux savoirs.
