...
\begin{figure}[h]
	\centering
	\includegraphics[height=12cm,width=12cm]{img-Chapiter-3/modele1.png}
	\caption{Architecture de système logiciel version 2 étape 1}
...
\begin{enumerate}
	...
	\item Modèle basé sur l'apprentissage profond pour entraîner sur l'ensemble des images thermiques.
	\item Enregistrer le modèle.
\end{enumerate}
\newpage
\begin{figure}[h]
	\centering
	\includegraphics[height=12cm,width=12cm]{img-Chapiter-3/modele2.png}
	\caption{Architecture de système logiciel version 2 étape 2}
	\label{fig:achdelasolu2}
\end{figure}
\begin{enumerate}
	\item Collecte l'image thermique du malade.
...
La figure \ref{fig:res} montre le résultat comment le programme au dessus détecter le visage.
\begin{figure}[h]
	\centering
	\includegraphics[width=8cm]{img-Chapiter-3/enfant.png}
...
\begin{figure}[h]
	...
	\caption{\' Elimination des bruits programmatiquement}
\end{figure}
...
\subsubsection*{L’entraînement du modèle}
...
\subsubsection*{L'évaluation du modèle}
