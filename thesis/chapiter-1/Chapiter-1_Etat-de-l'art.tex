...
\usepackage[hidelinks]{hyperref} % allows  clickable 
...
\begin{abstract} La sant\'e est la chose la plus importante pour chaque individu, vivre en bonne sant\' e c'est vivre heureux.\\
...
\textbf{Les mots cl\' es :} Deep Learning. \end{abstract}
\thispagestyle{empty}
\newpage
\renewcommand{\abstractname}{Abstract}
\begin{abstract} Health is the most important thing for every individual, to live in good health is to live happily. The developed countries give a major importance to this sector to make it intelligent, on the other side in the underdeveloped countries they find many difficulties related to health.\\
...
\rhead{\textsc{Introduction générale}}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{img-Chapiter-1/zeze.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=17cm]{img-Chapiter-1/neuron_model.jpeg}
...
\begin{figure}[h]
\centering
\includegraphics[width=10cm]{img-Chapiter-1/shemadenourone.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=14cm]{img-Chapiter-1/1.png}
...
\newpage
\rhead{\textsc{Chapitre 2 : Contexte et problématique du projet}}\setcounter{section}{0}
...
\end{figure}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=6cm]{img-Chapiter-2/infra.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=15cm]{img-Chapiter-3/processus.png}
...
\end{enumerate}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=10cm]{img-Chapiter-3/therPi.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{img-Chapiter-3/Picture1.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=12cm]{img-Chapiter-3/modele2.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=13cm]{img-Chapiter-4/batch.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=15cm]{img-Chapiter-4/loaddataset.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{img-Chapiter-4/loss.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{img-Chapiter-4/modele10.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=17cm]{img-Chapiter-4/first_result.png}
	\caption{Capture d’écran après l’exécution}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=12cm]{img-Chapiter-4/imgen.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=17cm]{img-Chapiter-4/output.png}
...
\begin{figure}[h]
	\centring
	\includegraphics[width=17cm]{img-Chapiter-4/11111.png}
...
\begin{figure}[h]
	\centring
	\includegraphics[width=17cm]{img-Chapiter-4/22222.png}
	\caption{Interface graphique de l'application}
	\label{fig:1001}
\end{figure}
...
\newpage
\rhead{\textsc{Conclusion générale}}
